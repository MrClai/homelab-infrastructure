...
### Вариант B — аварийный restore (сценарий отказа проверен)
...
- Аварийный сценарий (Вариант B) на реальном отказе проверен; изолированный
  restore сохранён как безопасная регулярная проверка.
